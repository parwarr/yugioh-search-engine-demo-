...
import { cardTypeEnum, monsterAttributeEnum, monsterSubTypeEnum, monsterTypeEnum } from "@prisma/client";
...
export class CreateCardDto {
    ...
    @ApiProperty({description: 'The type of the monster', enum: monsterTypeEnum, required: false})
    @IsOptional()
    @IsEnum(monsterTypeEnum)
    monsterType?: monsterTypeEnum

    @ApiProperty({description: 'The sub type of the monster', enum: monsterSubTypeEnum, required: false})
    @IsOptional()
    @IsEnum(monsterSubTypeEnum)
    monsterSubType?: monsterSubTypeEnum

    @ApiProperty({description: 'The attribute of the monster', enum: monsterAttributeEnum, required: false})
    @IsOptional()
